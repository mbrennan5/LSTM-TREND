...
#  11. Log-Ratio Protocol (v4.0 mandate) — 12 ratio features × 4 lenses × 3 = 144
# ==============================================================================
# ### BLOCK 0: GPU SETUP
# ==============================================================================
...
def generate_factory_features_v2(df):
    ...
    dominant_cycle_20 = pd.Series(hlc, index=idx).rolling(20).apply(
        _dominant_cycle_func, raw=True
    ).values
    ...
    # cycle_vs_trend: cycle period (positive) ÷ slope (signed) → velocity seed
    ...
    #
    # Z-LENS GROUP (15 base + 12 log-ratio) × 4 lenses × 3 transforms = 324
    # ─────────────────────────────────────────────────────────────────────────
    ...
    #
    #   Log-Ratio Protocol (12 features):
    #     Price Anchors:  kalman_sma_ratio, tema_kalman_ratio, exhaustion_60
    #     Velocity Seeds: ratio_acc, ratio_snr, curvature_diff, cycle_vs_trend
    #     Interactions:   ratio_eff_slope, ratio_pers_slope, ratio_struct,
    ...
    #
    # TOTAL: (15 + 12) × 4 × 3 + 3 = 324 + 3 = 327 features
    # ══════════════════════════════════════════════════════════════════════════
    ...
    Z_LENS_INDICATORS = {
        ...
        # ── Log-Ratio Protocol features (12 × 4 lenses × 3 = 144 sub-features) ─
        # Price Anchors
...
# Bounded indicators:   LENS_{10|30|60|90}_{name}_{z|z_slope|z_sos}
# Unbounded indicators: WIN_{10|30|60}_{name}_pct
